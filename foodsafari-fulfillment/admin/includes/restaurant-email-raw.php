			...
			<table>
				<tr>
					<td>
                        ...
                        Salamat $restnames[$key],
                        You have a booking for $bookingdata[tour]<br/>
                            Guest Booking Name: $bookingdata[cname]<br/>
                            Date: $rdate<br/>
                            Number of Guests: $bookingdata[nguests]<br/>
                            Time Allocation: $value <br/>
                            Special Requirements: $bookingdata[requirements]<br/><br/>
                                This is an automated email. Confirmation is deemed accepted. If unable to accept this booking respond ASAP to Bali Food Safari Indonesian Operations Manager.<br/><br/><b>Melky Schelling</b><br/>admin@balifoodsafari.com<br/>+62 89 605 293 637 OR +62 818 343 212";
                        
                        
                        
                        <p><b>Salamat '.$restnames[$key].',</b></p>
                        
                        <p class="emphasis">You have a booking for our '.$bookingdata['tour'].' Tour</p>
                        
                        <p>
                            <b>Guest Booking Name: </b>'.$bookingdata[cname].'<br/>
                            <b>Date: </b>'.$rdate.'<br/>
                            <b>Number of Guests: </b>'.$bookingdata['nguests'].'<br/>
                            <b>Time Allocation: </b>'.$value.'<br/>
